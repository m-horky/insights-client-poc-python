...
class Insights:
    ...
    def get_egg(self, route: Route, *, etag: Optional[str] = None) -> Response:
        """Download the egg.
    ...
    def get_egg_signature(self, route: Route) -> Response:
        raw: Response = self.connection.get(f"/static{route.url}/insights-core.egg.asc")
        return raw
